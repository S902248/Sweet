...
import { Settings, Shield, Store, CreditCard, Save, Printer, Upload, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="glass-card p-6 md:col-span-2">
          {activeTab === 'store' && (
            <>
              ...
              <form onSubmit={handleSaveStore} className="space-y-6" noValidate>
